...
import cn.sudiyi.platform.internal.PlatformAreaOperation;
import cn.sudiyi.platform.internal.PlatformConstants;
import cn.sudiyi.platform.internal.PlatformDeviceOperation;
import cn.sudiyi.platform.internal.PlatformLatticeOperation;
import cn.sudiyi.platform.internal.PlatformOrderOperation;
...
public class PlatformClient implements Platform {
    ...
    public void delivery(DeliveryRequest request) {
        orderOperation.delivery(request);
    }
