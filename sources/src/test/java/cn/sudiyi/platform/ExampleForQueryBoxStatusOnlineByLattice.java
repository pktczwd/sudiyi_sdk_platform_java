...
/**
 * 根据网点查询箱格状态和设备在线状态的示例
 * @author pankai
 * 2016年3月11日
 */
public class ExampleForQueryBoxStatusOnlineByLattice {
    ...
    public static void main(String[] args) {
        ...
        request.setId(37742);
        //发起一个查询请求,得到响应.
        List<QueryBoxStatusOnlineResponse> list = client.queryBoxStatusOnlineByLattice(request);
        //你的业务逻辑
        //输出可用的大箱数量
